...
export default function FriendsWithBenefits() {
  return (
    <section
      ...
      style={{ backgroundImage: "url('/assets/FwB.png')" }}
    >
        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-16 lg:gap-24">
          ...
          <div className="flex-1 w-full max-w-2xl flex flex-col justify-center items-start text-left pb-16 lg:pb-24 pt-8">
            ...
            >
              ...
              <span className="text-[#101828]">Special Offer</span>
            </motion.div>
            ...
            >
              Join the exclusive FWB membership for local deals, priority access, and your ultimate SA guide.
            </motion.p>
            ...
            >
              ...
              <div className="font-heading text-lg md:text-[22px] font-bold text-[#101828] leading-none sm:pt-1">
                for just <span className="text-primary font-black">$4.95</span>/month
              </div>
            </motion.div>
          </div>
            ...
            <div className="relative w-full max-w-[650px] lg:max-w-[754px] z-10 select-none">
              ...
              >
                ...
                <p className="font-body text-[14px] sm:text-[15px] font-medium text-[#101828]/80 leading-normal">
                  Grab <span className="text-primary font-extrabold">"Buy 1 Get 1 Free"</span> drinks and huge discounts at SA’s best pubs, wineries, and shops.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="font-body text-[14px] sm:text-[15px] font-medium text-[#101828]/80 leading-normal">
                  Get priority booking for <span className="text-primary font-extrabold">Cosi’s Choir</span> and special events before they sell out!
                </p>
              </motion.div>
            </div>
          </div>
